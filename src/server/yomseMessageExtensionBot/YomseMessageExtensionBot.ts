...
import YomseMessageExtension from "../yomseMessageExtension/YomseMessageExtension";
import { DialogSet, DialogState } from "botbuilder-dialogs";
// Initialize debug logging module
const log = debug("msteams");

/**
 * Implementation for yomse Message Extension Bot
 */
@BotDeclaration(
    "/api/messages",
    new MemoryStorage(),
...
export class YomseMessageExtensionBot extends TeamsActivityHandler {
    ...
    /** Local property for YomseMessageExtension */
    @MessageExtensionDeclaration("yomseMessageExtension")
    private _yomseMessageExtension: YomseMessageExtension;
    ...
    public constructor(conversationState: ConversationState) {
        super();
        // Message extension YomseMessageExtension
        this._yomseMessageExtension = new YomseMessageExtension();
